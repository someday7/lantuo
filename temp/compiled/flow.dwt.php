...
<link href="themes/default/css/ec.core.min.css?20150213" rel="stylesheet" type="text/css">
 <link href="themes/default/css/main.order.css" rel="stylesheet" type="text/css">
...
?>
		<div class="sc-pro-area selected" id="order-pro-2069">
		<table border="0" cellpadding="0" cellspacing="0">
		<tbody> 
            <tr class="sc-pro-item">
       
			  <td bgcolor="#ffffff" align="center" class="tr-pro" style="text-align:left; height:75px; width:600px; padding-left:10px;"> 
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                
				
				 <div class="pro-area clearfix"><p class="p-img">
				...
				</p><p class="p-name"> <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a></p><p class="p-sku"> <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              <?php echo nl2br($this->_var['goods']['goods_attr']); ?> 
              <?php endif; ?></p><p class="understock-2069 hide"></p></div> 
...
?>
              ...
              <td align="center" bgcolor="#ffffff" class="tr-price"><?php echo $this->_var['goods']['goods_price']; ?></td>
              <td align="center" bgcolor="#ffffff">
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
				  <span class="goods_cut" onclick="goods_cut('<?php echo $this->_var['goods']['rec_id']; ?>');">-</span>  
              ...
              <td align="center" bgcolor="#ffffff">
				...
				<a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>';" class="icon-sc-del" title="删除" seed="cart-item-del">删除</a>
            ...
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
			 ...
			 function goods_cut($val){  
				 var num_val=document.getElementById('goods_number_'+$val);  
				 var new_num=num_val.value;  
				 if(isNaN(new_num)){alert('请输入数字');return false}  
				 var Num = parseInt(new_num);  
				 if(Num>1)NumNum=Num-1;  
				 num_val.value=NumNum;  
...
.goods_number_tit{  
    ...
    float: left;  
			...
			<div id="cart-total-area" class="sc-total-area clearfix"><div class="sc-total-control">
			<!--label class="vam" for="checkAll-buttom">全选</labe><a class="vam" href="javascript:;" seed="cart-all-del">删除选中商品<l/a-->
			...
			<div class="sc-action-area clearfix"><a class="button-style-4 button-go-shopping-3" href="index.php">继续购物</a><a class="button-style-1 button-go-checkout-2" href="flow.php?step=checkout" seed="cart-pay">去结算</a> </div>
			   </div>
		</div>
...
?>
  ...
  <?php if ($this->_var['fittings_lis1t']): ?>
  <?php echo $this->smarty_insert_scripts(array('files'=>'transport.js')); ?>
  <script type="text/javascript" charset="utf-8">
...
?>
		 ...
		 <div class="fr">
            ...
            <div class="progress-area progress-area-3">
                ...
                <div id="progress-confirm" class="progress-co-area">填写核对订单信息</div>
	...
	<div class="layout">
		<style>
			.flowBox tr{height:35px;}
			.flowBox td{padding-left:10px;}
			</style>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
			...
			<a href="javascript:;"   class="button-style-1 butyle-1 button-submit-order" title="提交订单" seed="checkout-submit" onclick="document.getElementById('theForm').submit();"><span>提交订单</span></a>
        ...
        <?php if ($this->_var['step'] == "done"): ?>
		 ...
		 <div class="fr">
            ...
            <div class="progress-area progress-area-3">
                ...
                <div id="progress-submit" class="progress-sso-area ">成功提交订单</div>
            </div>
        </div>
		</div>
	</div>
